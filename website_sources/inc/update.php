...
if($_POST && $_FILES){
    ...
    && isset($_FILES['img_carrou_3'])){
        ...
        $id_gite = strip_tags($_POST['id_gite']);
        ...
        $uploadcheminpre = '../../assets/img_gite/img_pre/';
        $uploadchemincarrou = '../../assets/img_gite/img_carrou/';
        ...
        $sql = 'UPDATE `gite` SET `nom`=:nom, `dispo`=:dispo, `adresse`=:adresse, `prix`=:prix, `categorie`=:categorie, `nbr_couchage`=:nbr_couchage, 
                                  `nbr_sdb`=:nbr_sdb, `nbr_piece`=:nbr_piece, `equipement_1`=:equipement_1, `equipement_2`=:equipement_2, 
                                  `equipement_3`=:equipement_3, `equipement_4`=:equipement_4, `descrip`=:descrip, `img_pre`=:img_pre, 
                                  `img_carrou_1`=:img_carrou_1, `img_carrou_2`=:img_carrou_2, `img_carrou_3`=:img_carrou_3 WHERE `id_gite`=:id_gite;';
