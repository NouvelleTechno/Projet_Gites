            ...
            <div class=" form_contain">
                ...
                <div class="input_cate form-group">
                    ...
                    <div class="cate_gr">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="categorie" id="inlineRadio3" value="Maison" checked>
                ...
                <div class="nb">
                    <div class="form-group">
                        ...
                        <input name="nbr_couchage" type="number" min="1" max="15">
                    </div>
                    <div class="form-group">
                        <label for="nbr_sdb">NB de Sdb</label><br>
                        <input name="nbr_sdb" type="number" min="1" max="15">
                    </div>
                    <div class="form-group">
                        <label for="nbr_piece">NB de Pièce</label><br>
                        <input name="nbr_piece" type="number" min="1" max="15">
                    </div>
                </div>
