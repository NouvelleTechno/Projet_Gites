            ...
            <div class="form_contain">
                ...
                <div class="nb">
                    <div class="form-group">
                        ...
                        <input name="nbr_couchage" type="number" min="1" max="8" value="<?=$gite['nbr_couchage']?>">
                    </div>
                    <div class="form-group">
                        <label for="nbr_sdb">NB de Sdb</label><br>
                        <input name="nbr_sdb" type="number" min="1" max="8" value="<?=$gite['nbr_sdb']?>">
                    </div>
                    <div class="form-group">
                        <label for="nbr_piece">NB de Pièce</label><br>
                        <input name="nbr_piece" type="number" min="1" max="10" value="<?=$gite['nbr_piece']?>">
                    </div>
                </div>
