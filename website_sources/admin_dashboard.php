                ...
                <div class="ajout_deco">
                    <div class="dropdown bu_ajout">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <li><a class="dropdown-item" href="admin_ajout_gite.php?id=chambre">Une Chambre</a></li>
                            <li><a class="dropdown-item" href="admin_ajout_gite.php?id=appartement">Un Appartement</a></li>
                            <li><a class="dropdown-item" href="admin_ajout_gite.php?id=maison">Une Maison</a></li>
                        </ul>
                    </div>
                    <div class="deco">
                ...
                <div class="div_card">
                    <div class="card" style="width: 16rem;">
                        ...
                        <div class="contenu_card card-body">
                            ...
                            <div class="ico">
                                <a href="admin_details_gite.php?id_gite=<?= $id_gite?>"><img class="rubberBand" src="assets/img/icone/voir.png" alt="Inspecter" width="25px" height="25px"></a>
                                <a href="admin_modification_gite.php?id_gite=<?= $id_gite?>&amp;type=<?=$categorie?>"><img class="rubberBand" src="assets/img/icone/modif_ico.png" alt="Modif" width="25px" height="25px"></a>
